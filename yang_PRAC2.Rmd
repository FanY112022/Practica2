...
El intervalo de confianza del 95% de la media de sat es (1026.639; 1035.173).

El intervalo de confianza al 95% de sat para las mujeres es 1001.413 1013.107

El intervalo de confianza al 95% de sat para los hombres es 1044.257 1056.24

Los hombres tienen una media superior en SAT ('sat') que las mujeres con un nivel de confianza del 95%.
...
La nota media del primer semestre ('colgpa') de las mujeres es diferente a la nota media del primer semestre de los hombres con un nivel de confianza de 95%.


## Apartado 4

La capacidad explicativa del modelo de regresión lineal multiple no es muy buena para estimar la nota media del primer semestre (colgpa), puesto que solo explica un 29,81% de la varianza.

Todas las variables explicativas contribuyen significativamente a explicar el colgpa de los estudiantes. Las variables sat, female (TRUE), tothrs y athlete (TRUE) tienen una correlación positiva con la variable colgpa y la variable hsperc tiene una correlación negativa con colgpa. 

El modelo predice que un estudiante hombre, atleta, con sat de 800, horas total de 60 y ranking relativa del 60% tendrá una nota media del primer semestre (colgpa) de 1.85.

## Apartado 5

Casi todas las variables explicativas son significativos salvo athlete, black y white. Y las variables sat y female (TRUE) tienen una correlación positiva con la variable excelente. Mientras el resto de las variables (athlete, tothrs, black, white, hsperc) tienen una correlación negativa con excelente.

El modelo no tiene un ajuste bueno.

La variable female incrementa el odds de probabilidad de ser un estudiante excelente en un 53%.

La probabilidad de una estudiante que cumple las condiciones del apartado es de 14,38% de ser excelente.

## Apartado 6

La nota media del primer semestre (colgpa) es diferente para las distintas razas (blanca, negra y otras).

El 2,2% de la variabilidad total observada en colgpa se debe a la variabilidad observada entre las tres categorías.

El efecto de race es negativo para los estudiantes de raza negra y otra mientras que es positivo para los estudiantes de raza blanca.

Por último, el factor explica un 2,2 % de la variabilidad observada en colgpa. El resto (97,8%) es la parte no explicada por el modelo.

La mayoría de residuos se disponen de acuerdo con los cuantiles teóricos salvo que hay un cierto desajuste en los extremos de la distribución, que es habitual.

## Apartado 7

El factor race y el factor female tienen un efecto significativo sobre colgpa, y tienen una interacción entre ellos. No siguen una distribución ni cumplen la homoscedasticidad.
